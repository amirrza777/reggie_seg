...
function StaffDiscussionHeroSkeleton() {
  return (
...
function StaffDiscussionOverviewCardSkeleton() {
  return (
...
function StaffDiscussionInsightsCardSkeleton() {
  return (
    <section className="staff-projects__team-card" aria-hidden="true">
...
function StaffDiscussionPostsCardSkeleton() {
  return (
    <section className="staff-projects__team-card" aria-hidden="true">
...
function GithubReposHeroSkeleton() {
  return (
...
function GithubReposContentSkeleton() {
  return (
    <>
...
function EnterpriseForumReportsTableSkeleton() {
  return (
    <div className="table">
      ...
      {Array.from({ length: 4 }).map((_, rowIndex) => (
        <div key={rowIndex} className="table__row" style={{ gridTemplateColumns: "1.2fr 1.1fr 1.1fr 1.4fr 0.8fr 1fr" }}>
...
export function StaffDiscussionRouteSkeleton() {
  return (
    <div className="staff-projects" role="status" aria-live="polite">
      <StaffDiscussionHeroSkeleton />
      <StaffDiscussionOverviewCardSkeleton />
      <StaffDiscussionInsightsCardSkeleton />
      <StaffDiscussionPostsCardSkeleton />
...
export function GithubReposRouteSkeleton() {
  return (
    <div className="stack github-project-repos-section" role="status" aria-live="polite">
      <GithubReposHeroSkeleton />
      <GithubReposContentSkeleton />
    ...
    <div className="ui-page enterprise-overview-page" role="status" aria-live="polite">
      ...
      <div className="card user-management-card" aria-hidden="true">
        ...
        <div className="card__body">
          <EnterpriseForumReportsTableSkeleton />
        </div>
      </div>
