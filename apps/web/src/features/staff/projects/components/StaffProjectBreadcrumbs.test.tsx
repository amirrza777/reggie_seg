...
describe("StaffProjectBreadcrumbs", () => {
  ...
  it("renders base crumbs for project overview route", () => {
    ...
    render(<StaffProjectBreadcrumbs projectId="9" projectName="Alpha Project" teamNamesById={{}} />);
  ...
  it("renders team + peer assessment student crumbs", () => {
    usePathnameMock.mockReturnValue("/staff/projects/9/teams/4/peer-assessment/77");
    render(<StaffProjectBreadcrumbs projectId="9" projectName="Alpha Project" teamNamesById={{ "4": "Team Delta" }} />);

    expect(screen.getByRole("link", { name: "Team Delta" })).toHaveAttribute("href", "/staff/projects/9/teams/4");
  ...
  it("renders project trello child crumb with title-cased child label", () => {
    usePathnameMock.mockReturnValue("/staff/projects/9/trello/graphs");
    render(<StaffProjectBreadcrumbs projectId="9" projectName="Alpha Project" teamNamesById={{}} />);
