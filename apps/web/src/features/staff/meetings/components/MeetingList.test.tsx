...
describe("MeetingList", () => {
  ...
  it("renders meeting title and organiser name", () => {
    render(<MeetingList meetings={[makeMeeting()]} />);
    expect(screen.getByText("Team Meeting")).toBeInTheDocument();
    expect(screen.getByText("Alice Smith")).toBeInTheDocument();
  });

  it("shows not recorded when attendance is empty", () => {
    render(<MeetingList meetings={[makeMeeting({ attendances: [] })]} />);
  ...
  it("shows minutes writer name when minutes exist", () => {
    ...
    render(<MeetingList meetings={[makeMeeting({ minutes })]} />);
    expect(screen.getByText("Bob Jones")).toBeInTheDocument();
  });

  it("shows No when there are no minutes", () => {
    render(<MeetingList meetings={[makeMeeting({ minutes: null })]} />);
