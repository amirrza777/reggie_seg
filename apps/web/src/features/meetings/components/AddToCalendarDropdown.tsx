...
export function AddToCalendarDropdown({ meeting }: AddToCalendarDropdownProps) {
  ...
  return (
    <div ref={containerRef} className="atc-dropdown">
      <button
        type="button"
        className="btn btn--ghost atc-dropdown__trigger"
      ...
      {open && (
        <ul className="atc-dropdown__list" role="listbox">
          <li>
            <a
