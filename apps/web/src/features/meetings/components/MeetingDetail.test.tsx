...
describe("MeetingDetail", () => {
  ...
  it("renders meeting title and organiser", () => {
    render(<MeetingDetail meeting={baseMeeting} projectId={5} />);
  ...
  it("renders back link to meetings page", () => {
    render(<MeetingDetail meeting={baseMeeting} projectId={5} />);
    expect(screen.getByRole("link", { name: /back to previous meetings/i })).toHaveAttribute(
      "href",
      "/projects/5/meetings?tab=previous",
    );
  });

  it("shows location when provided", () => {
    render(<MeetingDetail meeting={{ ...baseMeeting, location: "Bush House 3.01" }} projectId={5} />);
  ...
  it("shows subject when provided", () => {
    render(<MeetingDetail meeting={{ ...baseMeeting, subject: "Sprint review" }} projectId={5} />);
  ...
  it("shows video call link when provided", () => {
    render(<MeetingDetail meeting={{ ...baseMeeting, videoCallLink: "https://meet.google.com/abc" }} projectId={5} />);
  ...
  it("shows agenda when provided", () => {
    render(<MeetingDetail meeting={{ ...baseMeeting, agenda: "Review tasks" }} projectId={5} />);
  ...
  it("shows attendance section when attendances exist", () => {
    ...
    render(<MeetingDetail meeting={withAttendances} projectId={5} />);
  ...
  it("shows minutes when present", () => {
    ...
    render(<MeetingDetail meeting={withMinutes} projectId={5} />);
  ...
  it("shows add to calendar for upcoming meetings", () => {
    ...
    render(<MeetingDetail meeting={upcoming} projectId={5} />);
  ...
  it("hides add to calendar for past meetings", () => {
    ...
    render(<MeetingDetail meeting={past} projectId={5} />);
